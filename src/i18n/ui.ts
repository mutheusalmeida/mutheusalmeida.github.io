...
export const ui = {
  en: {
    ...
    'endorsement.text': 'I was the project manager where Matheus worked as a front-end developer. Throughout the project, he was very helpful and always did his best to deliver. He always solved the problems we encountered, he was assertive and quick in his tasks, and tried to go beyond what was requested. He was a great project partner.',
  ...
  'pt-BR': {
    ...
    'about.para.third': `Anteriormente, trabalhei na <a href="https://www.linkedin.com/in/mutheusalmeida/#experience" target="_blank">Desenrolado</a>, onde construí 18 atividades interativas em React.js para crianças em idade escolar. Antes disso, trabalhei na <a href="https://www.linkedin.com/in/mutheusalmeida/#experience" target="_blank">Kolabs</a>, construí o site da empresa e liderei o desenvolvimento de UI dos seus projetos.`,
    'experience.title': 'Experiência',
    'experience.role': 'Desenvolvedor Front-End',
    'projects.title': 'Projetos',
    'endorsement.text': 'Eu era gestor do projeto em que o Matheus trabalhava como desenvolvedor front-end. Durante todo o projeto ele foi muito prestativo e sempre deu o seu melhor pra realizar as entregas. Sempre solucionou os problemas que encontrávamos, tinha assertividade e velocidade nas suas tarefas e procurava ir além do solicitado. Foi um grande parceiro de projeto.',
